...
@section('content')
    ...
    <div class="container-fluid page-header py-5 mb-4">
        <div class="container text-center py-5">
            <h1 class="display-2 text-white mb-4 animated slideInDown">Policy Library</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Policy Library</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid py-4">
        <div class="container">
            <div class="bg-light rounded p-4 mb-4">
                <form method="GET" action="{{ route('policy_library') }}" id="filterForm">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="search" name="search"
                                       placeholder="Search by policy name..." value="{{ request('search') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <a href="{{ route('policy_library') }}" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">
                    Found {{ $files->total() }} polic{{ $files->total() != 1 ? 'ies' : 'y' }}
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="bg-primary bg-opacity-10 rounded p-3">
                        <h6 class="mb-3"><i class="fas fa-folder-tree me-2"></i>Policy Categories</h6>
                        <div class="row">
                            @foreach($policyCategories as $category)
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto">
                                        <div class="btn-group w-100" role="group">
                                            ...
                                            <a href="{{ route('policy_library.download', $file->id) }}"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="documentModalLabel">Policy Document Preview</h5>
...
function viewDocument(fileId) {
    ...
    downloadBtn.onclick = function() {
        window.location.href = `/policy_library/download/${fileId}`;
    };
    ...
    // Load document
    fetch(`/policy_library/view/${fileId}`)
        .then(response => {
            if (response.ok) {
        ...
        .then(blob => {
            ...
            if (fileExtension === 'pdf') {
                preview.innerHTML = `
                    <iframe src="${url}" width="100%" height="700px" style="border: none;"></iframe>
                `;
            } else {
                preview.innerHTML = `
